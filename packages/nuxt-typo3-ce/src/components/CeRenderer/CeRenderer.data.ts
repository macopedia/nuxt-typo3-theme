...
export const CeRendererMockData = {
  content: [
    {
      id: 72,
      pid: 1,
    ...
    },
    {
      ...
      content: {
        header: 'Grupa ',
        subheader: 'Dowiedz się więcej',
        headerLayout: 1,
        headerPosition: 'left',
        headerLink: '',
        bodytext:
          '<h3>Witamy na naszej stronie.<br /> <span class="mobile-hidden">Znajdziesz tutaj wszystkie informacje na temat naszej grupy.</span></h3>',
        gallery: {
          position: {
            horizontal: 'left',
            vertical: 'above',
